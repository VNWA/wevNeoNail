  ...
  <div>
    <div class="container mx-auto">
        <form class="my-6" action="#">
          <div class="custom-underline my-7 ">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="col-span-1">
              ...
              <div class="flex items-start mb-4 justify-center">
                <label class="flex items-center space-x-2 cursor-pointer mr-3 lg:mt-2 mt-1">
                ...
                <p class="lg:text-base	 text-xs ">
                  I give my consent for Cosmo Group Sp. z o.o. to send marketing information to the provided email
                  address,
                </p>
              </div>
              <!-- Second Checkbox -->
              <div class="flex items-center">
                <label class="flex items-center space-x-2 cursor-pointer mr-3">
                  <input type="checkbox" class="hidden peer">
                  <div class="w-6 h-6 border border-gray-300 rounded-sm transition-all duration-300 peer-checked:bg-primary flex items-center justify-center ">
                    <svg class="w-4 h-4 text-white opacity-0 transition-opacity duration-300 peer-checked:opacity-100"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                      stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M5 12l5 5L20 7"></path>
                ...
                <p class="lg:text-base	 text-xs">I have read the privacy policy</p>
              </div>
            </div>
          </div>
        </form>
        <div class="grid lg:grid-cols-4 grid-cols-1">
          <div class="mr-7">
            <h4 class="pb-3 font-medium">INFORMATION</h4>
            <hr>
            <ul>
              <li class="py-2">
          ...
          <div class="mr-7">
            <h4 class="pb-3 font-medium">ONLINE STORE</h4>
            <hr>
            <ul>
              <li class="py-2">
          ...
          <div class="mr-7">
            <h4 class="pb-3 font-medium">DELIVERY FROM 4,90 €</h4>
            <hr>
            <ul>
              <li class="py-4 grid grid-cols-4 gap-3 ">
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/1.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/2.webp" />
                </div>
              </li>
              <h4 class=" font-medium">PAYMENT METHODS</h4>
              <li class="py-4 grid grid-cols-4 gap-3 ">
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/3.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/4.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/5.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/6.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/7.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/8.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/9.webp" />
                </div>
                <div class=" h-16 border border-black/50 flex items-center justify-center bg-white px-3">
                  <NuxtImg width="auto" height="100" src="/images/10.webp" />
                </div>
              </li>
            </ul>
          </div>
          <div class="mr-7">
            <h4 class="pb-3 font-medium">Contact</h4>
            <hr>
            <ul>
              <li class="py-3">
                tel: +34 931727651
      ...
      <hr class="mt-4 border-t-1 border-gray-300 ">
      <div class="container mx-auto">
        <div class="flex justify-between py-5">
          <p class="text-sm	">Copyright by neonail-espana.es</p>
          <p class="text-sm	">Interactive agency [ti] Powered by 2ClickShop</p>
        </div>
      </div>
  </div>
</template>
